...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :chef_client do |chef|
    chef.chef_server_url = "https://api.opscode.com/organizations/cyoa"
    chef.validation_key_path = "/home/tobyhede/.chef/cyoa-validator.pem"
  ...
  config.vm.box = "precise-server-cloud-32"
